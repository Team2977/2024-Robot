...
public class CANdleSub extends SubsystemBase {
    ...
    public void incrementAnimation() {
        switch(m_currentAnimation) {
            ...
            case SingleFade: changeAnimation(AnimationTypes.redStrobe); break;
            case greenStrobe: changeAnimation(AnimationTypes.Twinkle); break;
            case redStrobe: changeAnimation(AnimationTypes.greenStrobe); break;
    ...
    public void decrementAnimation() {
        switch(m_currentAnimation) {
            ...
            case redStrobe: changeAnimation(AnimationTypes.SingleFade); break;
            case greenStrobe: changeAnimation(AnimationTypes.redStrobe); break;
            case Twinkle: changeAnimation(AnimationTypes.greenStrobe); break;
